 ...
 *
 */
public abstract class H2GISEmbeddedDataStoreFactory extends JDBCDataStoreFactory {
...
//    }
    ...
    protected abstract DataSource createH2GisDataSource();
