...
object RunToolbox6Release {
  ...
  val Releases = Seq[NamedModule#Release](
    ...
    Toolbox6Modules.Modules.R11,

    Toolbox6Modules.Modules.R10,

    JarTreeModules.Common.R2,
    Toolbox6Modules.Modules.R9,

    AkkaModules.Http.R2,
    Toolbox6Modules.Jms.R4,
    AkkaModules.Stream.R3,
    AkkaModules.Actor.R2,
    JarTreeModules.Common.R1,
    Toolbox6Modules.Pickling.R4,
    Toolbox6Modules.Common.R4,
    Toolbox6Modules.Logging.R3,
    Toolbox6Modules.Modules.R8,

    JarTreeModules.Servlet.R6,
    JarTreeModules.Impl.R6,
    Toolbox6Modules.Logback.R2,
    Toolbox6Modules.Modules.R7,
